  ...
  return (
    <article className='residentCard'>
        ...
        <div className='residentCard__status'>
            <div  className={`residentCard__status-circle parpadea ${residentInfo?.status}`}></div>
        ...
        <section className='residentCard__info'>
            ...
            <ul className='residentCard__list'>
                ...
                <li className='residentCard__item'><span>Origin: </span>{residentInfo?.name} </li>
                <li className='residentCard__item'><span>Episodes where appear: </span>{residentInfo?.episode.length} </li>
            </ul>
        </section>
    </article>
  )
